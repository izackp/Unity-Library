...
namespace UnityEngine.EventSystems {
    [AddComponentMenu("Event/Better Standalone Input Module")]
    public class BetterStandaloneInputModule : PointerInputModule {
        ...
        protected BetterStandaloneInputModule() {
        }
        ...
        protected override void ProcessDrag(PointerEventData pointerEvent) {
            ...
            if (!pointerEvent.dragging
                ...
                bool horizontal = Math.Abs(pointerEvent.delta.x) > Math.Abs(pointerEvent.delta.y);
                GameObject found = FindHandler(pointerEvent.pointerDrag, horizontal);
                pointerEvent.pointerDrag = found;
